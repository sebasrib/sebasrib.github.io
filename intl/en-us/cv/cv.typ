...
Software Engineer with a proven track record of delivering #strong[high-availability solutions] for #strong[100M+ users]. Expertise in #strong[Node.js], #strong[Java], and #strong[Python], with a specialized focus on #strong[Microsservices], #strong[IAM (Keycloak, OAuth, OIDC)] and cloud architecture #strong[(AWS and OCI Certified)]. Combines a strong #strong[analytical foundation] - including data decision-making for #strong[Brazil's National Census] - with a drive to bridge complex backend architecture and business growth.
